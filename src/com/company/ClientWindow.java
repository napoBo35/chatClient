...
public class ClientWindow extends JFrame {
    ...
    public ClientWindow() {
        ...
        //label, который будет отрадать количество клиентов в чате
        ...
        rightPanel.setSize(100,600);
        add(rightPanel,BorderLayout.EAST);
        JList<String> jl = new JList<String>();
        JScrollPane jspr = new JScrollPane(jl);
        rightPanel.add(jspr,BorderLayout.CENTER);
        ...
        // обработчик события нажатия кнопки отправки сообщений
                ...
                try {
                    ...
                    while (true) {
                        if (inMessage.hasNext()) {
                            ...
                            if (inMes.indexOf(clientsInChat) == 0) jlNumberOfClients.setText(inMes);
                            else {
                                // выводим сообщение
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                ...
                try {
                    ...
                    if (!clientName.isEmpty() && clientName != "Введите ваше имя: ") outMessage.println(clientName + " вышел из чата");
                    else outMessage.println("Участник вышел из чата, так и не представившись!");
